...
function App() {
  ...
  return (
    <>
      ...
      <h1>Vite + React</h1>
      {/* {showbtn?<button>I will be shown only when another button is clicked</button>:"thenga"} */}
      {/* if showbtn true then follow the Command */}
      ...
      <div className="card">
        <button onClick={() => setshowbtn(() => setshowbtn(!showbtn))}>
          click me
        </button>
        <p>
